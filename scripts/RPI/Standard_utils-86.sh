...
sudo apt install -y bc curl ninja-build git ranger mc whowatch lsof nethogs fdupes ntfs-3g openssh-server ffmpeg ettercap-graphical stress ccze tilde nmap original-awk gawk trash-cli ioping chkrootkit fping lshw arping hping3 hexcurse ipcalc iftop wavemon bmon build-essential make cmake python3 python3-pip python2 tshark saidar xlsx2csv pwgen libcrack2 openjdk-11-jdk openjdk-11-jre build-essential make cmake gcc g++ git wget htop neofetch mosh screen bmon wavemon iftop ipcalc hexcurse hping3 arping lshw fping chkrootkit ioping stress ccze tilde nmap original-awk gawk wget zip unzip unrar-free tshark saidar xlsx2csv docx2txt pwgen libcrack2
